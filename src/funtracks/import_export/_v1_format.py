...
def load_v1_tracks(
    ...
    Args:
        ...
        solution (bool, optional): If true, returns a Tracks object, otherwise
    ...
    # a FeatureDict (older saves), declare tracklet/lineage intent explicitly so a
    # TrackAnnotator is registered.
    if solution and "features" not in attrs:
