...
def load_v1_tracks(
    directory: Path, seg_required: bool = False, solution: bool | None = None
) -> Tracks:
    ...
    Args:
        ...
        solution (bool | None, optional): Deprecated and ignored. Previously selected
            between Tracks and SolutionTracks; every Tracks now has track ids and is
            treated as the solution. Kept for backward compatibility.
    ...
    if solution is not None:
        warnings.warn(
            "The 'solution' argument to load_v1_tracks is deprecated and ignored: "
            "all loaded tracks are treated as the solution.",
            DeprecationWarning,
            stacklevel=2,
        )
